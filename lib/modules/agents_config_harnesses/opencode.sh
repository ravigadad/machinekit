...
# opencode by symlinking its global instructions file (AGENTS.md in opencode's XDG
# config dir) to the dir's AGENTS.md. opencode reads skills from the shared dir natively, so
